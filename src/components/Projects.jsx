        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-8">
            ...
            <div className="d-flex flex-wrap justify-content-center gap-3 mt-3">
              ...
              <img src="/Technologies/zbrush logo.png" alt="ZBrush" className="img-fluid" style={{width: "50px", height: "50px"}}/>
    ...
    <div className="container my-5" id="Project1" style={{backgroundColor: "rgb(9 9 9)", padding: "1rem", borderRadius: "0.5rem", border: "2px solid #222"}}>
        <div className="row align-items-center">
          ...
          <div className="col-md-8">
            ...
            <div className="text-center mt-3">
              <a href="https://github.com/ivanalggon/ViewingPartyValorant" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Ver en GitHub</a>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className="container my-5" id="Project1" style={{backgroundColor: "rgb(9 9 9)", padding: "1rem", borderRadius: "0.5rem", border: "2px solid #222"}}>
        <div className="row align-items-center">
          <div className="col-md-3 text-center mb-4 mb-md-0">
            <img src="public\Projects\Portada.jpg" 
                alt="Proyecto" 
          ...
          <div className="col-md-8">
            ...
            <div className="d-flex flex-wrap justify-content-center gap-3 mt-3">
              <img src="public\Technologies\Unity-logo.png" alt="Unity" className="img-fluid" style={{width: "50px", height: "50px"}}/>
              <img src="public\Technologies\Csharp_Logo.png" alt="C#" className="img-fluid" style={{width: "50px", height: "50px"}}/>
              <img src="public\Technologies\3ds-max.png" alt="3ds-max" className="img-fluid" style={{width: "50px", height: "50px"}}/>
              <img src="public\Technologies\substance-painter-logo.png" alt="Substance Painter" className="img-fluid" style={{width: "50px", height: "50px"}}/>
            </div>
